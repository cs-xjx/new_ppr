function [res] = collApxPPR_MutualExclusion(a, c, n_blocks, src, tar, qu, r, ds) 
time_total = tic;
fprintf('\n >> Start collApxPPR_MutualExclusion ... \n');
...
%
time_gen_pwd = tic;
fprintf(' >> Generate Possible Worlds ... \n');
